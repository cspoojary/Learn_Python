...
# 4. Write for loop statement to print the following series: 105,98,91 ……. 7 
'''count = 105
while count > 0:
    print(count,end=' ')
    count = count - 7'''
...
# 5. Write a Python program that print  first 10 natural numbers using while loop in reverse order.
''''num = 10
count = 1
